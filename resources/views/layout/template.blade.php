...
<body>
                        ...
                        <ul id="navbar"
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu animate slide border">
                                    ...
                                    <li><a href="/" class="dropdown-item fw-light">About</a></li>

                                    <li><a href="/" class="dropdown-item fw-light">Shop</a></li>

                                    <li><a href="/" class="dropdown-item fw-light">Single Product</a></li>

                                    <li><a href="/" class="dropdown-item fw-light">Cart</a></li>

                                    <li><a href="/" class="dropdown-item fw-light">Checkout</a></li>

                                    <li><a href="/" class="dropdown-item fw-light">Blog</a></li>

                                    <li><a href="/" class="dropdown-item fw-light">Single Post</a></li>

                                    <li><a href="/" class="dropdown-item fw-light">Contact</a></li>
                        ...
                        <div class="user-items d-flex">
                            <ul class="d-flex justify-content-end list-unstyled mb-0">
                                ...
                                <li class="wishlist-dropdown dropdown pe-3">
                                    ...
                                    <div
                                        class="dropdown-menu animazte slide dropdown-menu-start dropdown-menu-lg-end p-3">
                                        <h4 class="d-flex justify-content-between align-items-center mb-3">
                                            <span class="text-primary">Your wishlist</span>
                                            <span class="badge bg-primary rounded-pill">{{count($wishlist)}}</span>
                                        </h4>
                                        <ul class="list-group mb-3">
                                            @foreach ($wishlist as $id => $item)
                                                <li
                                                    class="list-group-item bg-transparent d-flex justify-content-between lh-sm">
                                                    {{-- <div class="me-2"><img src="{{asset('images/'.$item['image'])}}" style="width: 30px" alt=""></div> --}}
                                                    <div>
                                                        <h5 class="text-start" style="font-weight: 500">
                                                            <a href="/{{$item['id']}}">{{$item['title']}}</a>
                                                        </h5>
                                                        <a href="/addToCart/{{$item['id']}}"
                                                            class="d-block fw-medium text-capitalize mt-2"><i class="bi bi-cart-plus"></i> Add to cart</a>
                                                    </div>
                                        ...
                                        <div class="d-flex flex-wrap justify-content-center">
                                            <a href="/AddToCartFromWishlist" class="w-100 btn btn-dark mb-1" type="submit">Add all
                                                to cart</a>
                                            <a href="/wishlist" class="w-100 btn btn-primary" type="submit">View
                                                wishlist</a>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div
                                        ...
                                        <ul class="list-group mb-3">
                                            ...
                                            <li class="list-group-item bg-transparent d-flex justify-content-between">
                                                ...
                                                <strong class=" fw-bolder">${{ number_format($totalPrice,'0',',','.')}}</strong>
                                            </li>
                                        </ul>
                                        <div class="d-flex flex-wrap justify-content-center">
    ...
    @if (session('success'))
        <div id="success-alert"
            class="position-fixed bottom-0 end-0 mb-3 me-3 p-3 alert alert-success shadow-lg  fade show d-flex align-items-center"
            role="alert" style="display: none; min-width: 250px;z-index:999;">
    ...
    @if (session('error'))
        <div id="error-alert"
            class="position-fixed bottom-0 end-0 mb-3 me-3 p-3 alert alert-danger shadow-lg fade show d-flex align-items-center"
            role="alert" style="display: none; min-width: 250px; z-index: 999;">
            <i class="bi bi-x-circle-fill me-2"></i> Addition failed.
        </div>
    ...
    {{-- Footer --}}
    <footer id="footer" class="padding-large border-top border-2">
